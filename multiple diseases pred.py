...
diabetes_model = pickle.load(open('C:/multiple disease prediction/trained_model.sav','rb'))

heart_disease_model = pickle.load(open('C:/multiple disease prediction/heart_model.sav','rb'))

parkinsons_model = pickle.load(open('C:/multiple disease prediction/parkinsons_model.sav','rb'))
